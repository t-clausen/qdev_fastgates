    ...
    if betterColoumb == True:
        ...
        for i in range(len(siliconCords)-1,0-1,-1):
            ...
            if unevCordCount == 1 or unevCordCount == 3:
                siliconCords = np.delete(siliconCords,i,axis=0)
        ...
        for i in range(1,len(centralCorners)):
            if round(centralCorners[i][0],dec) != round(centralCorners[0][0],dec):
                xPoint = i
            if round(centralCorners[i][1],dec) != round(centralCorners[0][0],dec):
                yPoint = i
            if round(centralCorners[i][2],dec) != round(centralCorners[0][0],dec):
                zPoint = i
        for x in frange(centralCorners[0],centralCorners[x],(centralCorners[1]-centralCorners[0])/)
        ...
        #definer krystal
        #lav en loop der for hver latticeline finder pot funktionenen
        #lav et gennemsnit
        siliconCords = np.delete(siliconCords,0)
elif case == "kronig":
